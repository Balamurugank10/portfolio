...
function Education() {
  return (
    <div className='education'>
      ...
      <EducationCard schoolName="Lakshmi Chordia Matric Hr. Sec. School, Cuddalore" standard="HSC-XII" startingYear='2019' endingYear='2020' grade='73%' />
      <EducationCard schoolName="Lakshmi Chordia Matric Hr. Sec. School, Cuddalore" standard="SSLC-X" startingYear='2017' endingYear='2018' grade='79.8%' />
